---
description: Compatibility alias for optional second eye (legacy -openai name). Dispatched only when roles.adversary.secondEyeModel is set. Remove after 0.54.0.
mode: subagent
model: xai/grok-4.5
temperature: 0.3
permission:
