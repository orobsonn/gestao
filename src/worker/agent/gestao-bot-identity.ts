 ...
 * necessarily duplicated in the agent module. The drift oracle — asserting that the
 * `agentName` string literal in `.flue/agents/gestao-bot.ts` equals
 * GESTAO_BOT_AGENT_NAME — lands together with the agent-module rewrite and is not
 * present yet.
 *
